...
// Source : schémas matériels validés (mai 2026)
// ============================================================
...
// ── PMU AXP2101 ──────────────────────────────────────────────
// IRQ non confirmé sur les schémas fournis, conserver 3 en attente.
...
#define PIN_ES7210_DIN    10   // ligne data IN partagée côté capture/codec ctrl
